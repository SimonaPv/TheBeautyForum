    ...
    public class AppointmentConfiguration : IEntityTypeConfiguration<Appointment>
    {
        ...
        private ICollection<Appointment> AppointmentsData()
        {
            ...
            var app = new Appointment()
            {
                ...
                StartDate = DateTime.ParseExact("22-04-2024 12:30", "dd-MM-yyyy HH:mm", CultureInfo.InvariantCulture),
                EndDate = DateTime.ParseExact("22-04-2024 13:30", "dd-MM-yyyy HH:mm", CultureInfo.InvariantCulture),
            ...
            app = new Appointment()
            {
                ...
                StartDate = DateTime.ParseExact("22-04-2024 14:00", "dd-MM-yyyy HH:mm", CultureInfo.InvariantCulture),
                EndDate = DateTime.ParseExact("22-04-2024 15:00", "dd-MM-yyyy HH:mm", CultureInfo.InvariantCulture),
